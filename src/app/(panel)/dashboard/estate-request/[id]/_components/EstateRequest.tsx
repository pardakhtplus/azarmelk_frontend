...
export default function EstateRequest() {
  ...
  return (
    <div className="space-y-6 pt-10">
      ...
      <div className="rounded-2xl border-gray-200 bg-white p-0 shadow-sm sm:border sm:p-6">
        <h2 className="mb-4 flex items-center gap-2.5 text-lg font-semibold text-gray-900">
          <IUser className="size-5 text-green-600" />
          اطلاعات کاربر
        </h2>
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
          <div className="rounded-xl border border-gray-200 bg-gray-50 p-4">
            <div className="mb-2 flex items-center gap-2">
              <IUser className="size-5 text-gray-600" />
          ...
          <div className="rounded-xl border border-gray-200 bg-gray-50 p-4">
            <div className="mb-2 flex items-center gap-2">
              <IUser className="size-5 text-gray-600" />
              <span className="font-semibold text-gray-900">شماره تماس</span>
            </div>
            <div className="flex w-full items-center justify-between gap-2">
              <p className="-mb-1 text-lg font-medium text-gray-600">
                {request.data.user.phoneNumber}
              </p>
              <button
                className="flex size-7 items-center justify-center rounded-full bg-primary-blue text-white"
                onClick={() => {
                  window.open(`tel:${request.data.user.phoneNumber}`, "_blank");
                }}>
